...
def word_search(wordlist, word, start, end):
    if end - start <= 1:
        return None 
    else:
        ...
        elif word < wordlist[middle] or word < wordlist[middle].lower():
            return word_search(wordlist, word, start, middle)
        elif word > wordlist[middle] or word > wordlist[middle].lower():
            return word_search(wordlist, word, middle, end)
